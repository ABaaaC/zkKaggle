...
echo "Compiling cifar_net3.circom..."

# compile circuit

# circom cifar_net.circom --r1cs --wasm --sym -o cifar_net
# circom cifar_net2.circom --r1cs -c --sym -o cifar_net
# circom cifar_net3.circom --r1cs --wasm --sym -o cifar_net
echo "circom done..."
snarkjs r1cs info cifar_net/cifar_net3.r1cs

# Start a new zkey and make a contribution

snarkjs groth16 setup cifar_net/cifar_net3.r1cs powersOfTau28_hez_final_25.ptau cifar_net/circuit_0000.zkey
